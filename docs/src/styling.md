...
These themes style the `hl-*` classes generated by tree-sitter syntax highlighting. See [Syntax Highlighting](./syntax-highlighting.md) for the full list of highlight classes and customization options.
