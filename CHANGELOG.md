...
- Changelog for v0.1.34

### Miscellaneous

- Fix git-cliff workdir in release hook
- Remove rogue CHANGELOG.md
- Disable crates.io publishing in release config
...
- Fix clippy lints
- Clean up old content and styles folders, update docs
- Remove github workflows
- Remove CI for now from GitHub workflow
- Project setup, license, change log, readme
...
- Get github workflows going again
- Change project name to yew-ssg
- Add CI github workflows, scaffold test site
